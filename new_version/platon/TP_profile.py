...
class Profile:
    ...
    def set_from_params_dict(self, profile_type, params_dict):
        if profile_type == "isothermal":
            ...
            self.set_parametric(
                params_dict["T0"], 
                10**params_dict["log_P1"],
                params_dict["alpha1"], 
                params_dict["alpha2"],
                10**params_dict["log_P2"], 
                10**params_dict["log_P3"])
        elif profile_type == "radiative_solution":
            self.set_from_radiative_solution(
                params_dict["T_star"],
                params_dict["Rs"],
                params_dict["a"],
                params_dict["Mp"],
                params_dict["Rp"],
                params_dict["beta"],
                params_dict["log_k_th"],
                params_dict["log_gamma"],
                params_dict.get("log_gamma2"),
    ...
    def set_from_opacity(self, T_irr, info_dict, visible_cutoff=0.8e-6, T_int=100):
        """opacity-based temperature profile"""
