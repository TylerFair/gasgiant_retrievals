...
class TransitDepthCalculator:
    ...
    def compute_depths(self, t_p_profile, star_radius, planet_mass, planet_radius,
        ...
        gas_absorption_contrib: xp.ndarray, optional
            Pre-computed gas absorption cross sections.  If you are calling
            compute_depths repeatedly with the same abundance parameters, you can
            pre-compute this array to save time.  It can be computed using
            `platon.transit_depth_calculator.TransitDepthCalculator.atm._get_gas_absorption`
       ...
       '''
        ...
        atm_info = self.atm.compute_params(
            ...
            gas_absorption_contrib=gas_absorption_contrib)
