...
class CombinedRetriever:
    def pretty_print(self, fit_info):
        ...
        for i, name in enumerate(fit_info.fit_param_names):            
            ...
            if name in ["offset_transit", "offset_eclipse", "offset_niriss", "offset_nrs1", "offset_miri"]:
                unit = "ppm"
                value *= 1e6
    ...
    def _ln_like(self, params, transit_calc, eclipse_calc, fit_info, measured_transit_depths,
        ...
        try:
            if measured_transit_depths is not None:
                ...
                #calculated_transit_depths[0:1010] += params_dict["offset_niriss"]
                #calculated_transit_depths[1010:2397] += params_dict["offset_nrs1"]
                #calculated_transit_depths[4411:] += params_dict["offset_miri"]
    ...
    def run_multinest(self, transit_bins, transit_depths, transit_errors,
                      ...
                      include_condensation=True, rad_method="xsec",
                      maxiter=None, maxcall=None, nlive=250,
                      num_final_samples=2000, zero_opacities=[],
                      **dynesty_kwargs):
        import pymultinest
    ...
    def get_default_fit_info(Rs, Mp, Rp, T=None, logZ=0, CO_ratio=0.53, log_CH4_mult=0,
                             ...
                             T_spot=None, spot_cov_frac=None, cloud_cov_frac=None,
                             frac_scale_height=1,
                             log_number_density=-np.inf, log_part_size=-6,
                             n=None, log_k=-np.inf,
                             log_P_quench=-99,
                             offset_niriss=0, offset_nrs1=0, offset_miri=0, offset_eclipse=0, offset_start=0, offset_end=sys.maxsize,
